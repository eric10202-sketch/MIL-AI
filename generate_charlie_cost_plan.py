...
Generates Charlie_Cost_Plan.xlsx (formatted Excel workbook)
...
7 months: 01 Apr 2026 -> 31 Oct 2027 | 37 worldwide sites | 3500+ users | TBD apps | No ERP | No TSA
PM: Gill Amandeep Singh (BD/MIL-PSM1)

Run:  python generate_bravo_cost_plan.py
Output: Charlie\\Charlie_Cost_Plan.xlsx
"""
...
XLSX_PATH = OUT_DIR / "Charlie_Cost_Plan.xlsx"
...
METADATA = [
    ("Based on:", "Charlie_Project_Schedule.xlsx"),
    ("Risk-aligned:", "Charlie_Risk_Register.xlsx"),
    ("Project:", "Charlie  |  Seller: Robert Bosch GmbH  |  Buyer: Undisclosed"),
    ("PM:", "Gill Amandeep Singh (BD/MIL-PSM1)"),
    ("Sites / Users / Apps:", "37 (Worldwide)  |  3500+ users  |  TBD apps  |  No ERP  |  No TSA"),
    ("Duration:", "01 Apr 2026 â€“ 31 Oct 2027  (7 months)"),
...
CATEGORIES = [
    ...
    ("IT PROJECT MANAGEMENT", [
        ("Robert Bosch GmbH IT PM",                      "IT Project Management",             85,  680, 120,  81600),
        ("WS Leads",                        "Workstream Coordination",           40,  320, 100,  32000),
    ]),
    ("INFRASTRUCTURE & CLOUD", [
        ("Robert Bosch GmbH AD Team",                    "Active Directory Build (JV Forest)", 15, 120, 110,  13200),
        ("Robert Bosch GmbH Azure Team",                 "M365 Tenant & Azure Setup",         15,  120, 110,  13200),
        ("Robert Bosch GmbH Infra",                      "Network Setup (2 India Sites)",     15,  120, 100,  12000),
        ("Robert Bosch GmbH CISO",                       "Security & IAM Platform",           12,   96, 120,  11520),
        ("Robert Bosch GmbH Cloud Team",                 "Cloud Environment Configuration",   10,   80, 110,   8800),
    ]),
    ("APPLICATION MIGRATION", [
        ("Robert Bosch GmbH IT Architects",  "Application Deep-Dive & Classification (TBD apps)",  15, 120, 110, 13200),
        ("Dev Teams",           "Application Reconfiguration for JV (TBD apps)",      20, 160, 100, 16000),
        ("App Teams + Test Team","Integration & UAT Testing (TBD apps)",              15, 120,  90, 10800),
        ("Robert Bosch GmbH IT + Riyaz Ahmed","Data Migration Execution",                         12,  96, 100,  9600),
        ("Robert Bosch GmbH Procurement + IT","License & Contract Review (TBD apps)",              12,  96,  90,  8640),
    ]),
    ("CLIENT WORKPLACE", [
        ("Robert Bosch GmbH IT + Asset Mgmt","Device Inventory & Assessment (70 devices)",         5,  40,  90,  3600),
        ("Robert Bosch GmbH CWP",            "Device Reimaging - JV Standard Image (70 devices)", 10,  80,  90,  7200),
        ("IT Ops",              "Help Desk Activation & Training",                    5,  40,  90,  3600),
    ]),
    ("ARCHITECTURE & DESIGN", [
        ("Robert Bosch GmbH IT Architects",      "As-Is Analysis & Architecture Design",      20, 160, 120, 19200),
        ("Robert Bosch GmbH + Undisclosed Architects",  "JV Architecture Workshop Facilitation",      5,  40, 120,  4800),
        ("Robert Bosch GmbH CISO",               "Security Architecture Design",               8,  64, 120,  7680),
    ]),
    ("LEGAL & COMPLIANCE", [
    ...
    ("HR IT", [
        ("Robert Bosch GmbH HR IT",              "HR IT Mapping (3500+ Users)",                   5,  40,  90,  3600),
    ]),
    ("HYPERCARE & CLOSURE", [
        ("IT Ops + Help Desk",              "Hypercare Operations (60 working days)",     60, 480, 90, 43200),
        ("App Teams + IT Ops",              "Application Stability Monitoring (TBD apps)", 30, 240, 90, 21600),
        ("Riyaz Ahmed + Bosch BD/MIL",      "Programme Closure",                          15, 120, 175, 21000),
    ]),
]

PHASE_BREAKDOWN = [
    ("Phase 0 - Initialization (01 Apr â€“ 30 Apr 2026)",          55000),
    ("Phase 1 - Concept (01 May â€“ 15 May 2026)",                 38000),
    ("Phase 2 - Architecture & Design (11 May â€“ 29 May 2026)",   72000),
    ("Phase 3 - Build and Test (01 Jun â€“ 26 Jun 2026)",         165000),
    ("Phase 4 - GoLive & Closure (29 Jun â€“ 31 Oct 2027)",       224040),
]

CAPEX_ROWS = [
    ("M365/Azure JV Tenant Licensing (<3500+ users)",      "Robert Bosch GmbH Procurement",  "TBC - to be confirmed at QG0"),
    ("India Cloud Infrastructure (2 sites)",            "Robert Bosch GmbH Cloud Team",   "TBC - to be confirmed at QG0"),
    ("Network Circuit Setup (2 India JV Sites)",        "Robert Bosch GmbH Infra",        "TBC - to be confirmed at QG0"),
    ("Device Hardware Replacement if required (â‰¤70 devices)", "Robert Bosch GmbH CWP",   "TBC - to be confirmed at QG0"),
...
NOTES = [
    ...
    "Risk contingency lines derived from Charlie_Risk_Register.xlsx: Risk #1 (Amber; P4xI4=16) and Risk #3 (Amber; P3xI3=9).",
    "No TSA cost provision required: Bosch-led JV; Robert Bosch GmbH services available via normal governance channels post-GoLive.",
...
def write_xlsx(path: Path):
    ...
    # â”€â”€ Title banner â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ws.merge_cells(f"A{r}:F{r}")
    c = ws.cell(row=r, column=1, value="PROJECT CHARLIE â€” IT Cost Plan (Labour Only)")
    ...
    # â”€â”€ Category sections â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    alt = False
    for cat_name, resources in CATEGORIES:
        ...
        # Subtotal row
        ws.cell(row=r, column=1, value=f"SUBTOTAL â€” {cat_name}").font = font(bold=True, size=9)
    ...
    # â”€â”€ Overall Total â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Cost Breakdown by Category â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ws.merge_cells(f"A{r}:F{r}")
    ...
    # â”€â”€ Cost Breakdown by Phase â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ws.merge_cells(f"A{r}:F{r}")
    ...
    # â”€â”€ CAPEX / Additional Costs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ws.merge_cells(f"A{r}:F{r}")
    ...
    for note in NOTES:
        ws.merge_cells(f"A{r}:F{r}")
        c = ws.cell(row=r, column=1, value=f"â€¢ {note}")
