...
Generates Charlie_Executive_Dashboard.html
...
OUT      = HERE / "Charlie" / "Charlie_Executive_Dashboard.html"
...
<head>
  ...
  <title>Project Charlie â€“ Executive Dashboard</title>
  <style>
    :root {{
...
<div class="page">
  ...
  <div class="header">
    <div class="header-left">
      ...
      <h1>Project Charlie â€” Executive Dashboard</h1>
      <div class="sub">Robert Bosch GmbH AI Business Carve-Out â†’ 50/50 JV with Undisclosed &nbsp;|&nbsp; Bosch Leadership Control &nbsp;|&nbsp; Stand Alone Model</div>
      <div class="sub" style="margin-top:6px">Seller: Robert Bosch GmbH &nbsp;|&nbsp; Buyer: Undisclosed &nbsp;|&nbsp; PM: Gill Amandeep Singh (BD/MIL-PSM1)</div>
    </div>
    <div class="header-right">
      <div style="font-size:12px;opacity:.8">Dashboard date: {today.strftime('%d %b %Y')}</div>
      <div class="days">{days_to(golive)}</div>
      <div style="font-size:12px">days to GoLive (01 Jun 2027)</div>
  ...
  <div class="section">
    ...
    <div class="grid-2">
      <div>
        <p><strong>Objective:</strong> Carve out Robert Bosch GmbH's AI Business into a newly formed 50/50 Undisclosedâ€“Bosch Joint Venture with Bosch retaining leadership control. The JV operates effectively as a Bosch-governed entity â€” eliminating the need for a TSA, Merger Zone, or antitrust filings.</p>
        <p style="margin-top:10px"><strong>Scope:</strong> 17 AI applications, 3500+ users, 37 worldwide sites. No ERP or SAP in scope. Single-wave application migration. No TSA post-GoLive.</p>
        <p style="margin-top:10px"><strong>Key Simplification:</strong> Bosch's operational leadership of the JV dramatically reduces separation complexity versus a full Stand Alone model. Robert Bosch GmbH governance and escalation paths remain intact post-GoLive.</p>
      </div>
      <div>
    ...
    <div style="margin-top:14px">
      ...
      <div class="timeline">
        <div class="tphase p1" style="flex:22">Phase 1: Initialization<br/><span style="font-weight:400;font-size:10px">01 Apr â€“ 30 Apr 2026</span></div>
        <div class="tphase p2" style="flex:21">Phase 2: Concept &amp; Architecture<br/><span style="font-weight:400;font-size:10px">01 May â€“ 29 May 2026</span></div>
        <div class="tphase p3" style="flex:20">Phase 3: Build &amp; Test<br/><span style="font-weight:400;font-size:10px">01 Jun â€“ 26 Jun 2026</span></div>
        <div class="tphase p4" style="flex:4">P4<br/><span style="font-weight:400;font-size:10px">29 Junâ€“2 Jul</span></div>
        <div class="tphase p5" style="flex:85">Phase 5: Hypercare &amp; Closure<br/><span style="font-weight:400;font-size:10px">06 Jul â€“ 31 Oct 2027</span></div>
      </div>
    </div>
  </div>
  ...
  <div class="grid-2" style="margin-bottom:14px">
    ...
    <div class="section">
      ...
      <table>
        ...
        <tr><td>Signing â€“ Frozen Zone</td><td>07 Apr 2026</td><td>{days_to(signing):+d}</td><td><span class="pill g">DONE</span></td></tr>
        <tr><td>QG0 â€“ Initialization</td><td>30 Apr 2026</td><td>{days_to(qg0):+d}</td><td><span class="pill a">UPCOMING</span></td></tr>
        <tr><td>GoLive (Day 1) â€“ 01 Jun 2027</td><td>01 Jun 2027</td><td>{days_to(golive):+d}</td><td><span class="pill a">PLANNED</span></td></tr>
        <tr><td>QG1/2/3 â€“ Combined Gate</td><td>26 Jun 2026</td><td>{days_to(qg123):+d}</td><td><span class="pill a">PLANNED</span></td></tr>
        <tr><td>QG4 â€“ GoLive Gate</td><td>02 Jul 2026</td><td>{days_to(qg4):+d}</td><td><span class="pill a">PLANNED</span></td></tr>
        <tr><td>Hypercare Close</td><td>25 Sep 2026</td><td>{days_to(hypercare):+d}</td><td><span class="pill a">PLANNED</span></td></tr>
        <tr><td>QG5 â€“ Programme Closure</td><td>31 Oct 2027</td><td>{days_to(qg5):+d}</td><td><span class="pill a">PLANNED</span></td></tr>
      </table>
    </div>
    <!-- Budget -->
    <div class="section">
      ...
      <p style="font-size:12px;color:var(--muted);margin-bottom:14px">Labour only &nbsp;|&nbsp; CAPEX TBC â€“ to be approved at QG0</p>
  ...
  <div class="section">
    ...
    <div class="grid-3">
      <div class="ws-card">
        <div class="ws-title">WS1 â€“ PMO &amp; Governance</div>
      ...
      <div class="ws-card">
        <div class="ws-title">WS2 â€“ JV Legal &amp; Entity Setup</div>
        <div class="ws-body">India MCA registration (50/50 Undisclosed-Bosch; Bosch leadership); no antitrust filing</div>
        <div class="ws-conf c-med">MEDIUM Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS3 â€“ Infrastructure &amp; Cloud</div>
        <div class="ws-body">JV AD forest, M365 &lt;70 mailboxes, Azure tenant, network on 37 worldwide sites</div>
        <div class="ws-conf c-high">HIGH Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS4 â€“ Application Migration</div>
        <div class="ws-body">17 AI apps in single wave; re-point to JV domain/AD/M365; no ERP dependency</div>
        <div class="ws-conf c-high">HIGH Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS5 â€“ Data Separation</div>
        <div class="ws-body">AI business data separated from Robert Bosch GmbH; model artefacts, training data ownership mapped</div>
        <div class="ws-conf c-med">MEDIUM Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS6 â€“ Client Workplace</div>
        <div class="ws-body">70 devices; JV standard image; reimaging across 37 worldwide sites; no travel required</div>
        <div class="ws-conf c-high">HIGH Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS7 â€“ Security &amp; IAM</div>
        <div class="ws-body">JV-independent security platform; ISO 27001 baseline; Robert Bosch GmbH CISO standards retained</div>
        <div class="ws-conf c-high">HIGH Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS8 â€“ HR IT</div>
        <div class="ws-body">India payroll &amp; HR mapping for 70 AI business users; 2 India site coverage</div>
        <div class="ws-conf c-high">HIGH Confidence</div>
      </div>
      <div class="ws-card">
        <div class="ws-title">WS9 â€“ Licence &amp; Procurement</div>
  ...
  <div class="grid-2" style="margin-bottom:14px">
    ...
    <div class="section">
      ...
      <table>
        ...
        <tr>
          ...
          <td>Architecture approved; all TBD apps tested; 70 devices configured; JV infra ready; UAT passed; proceed to Cutover</td>
        </tr>
        <tr>
          <td><strong>QG4</strong></td><td>02 Jul 2026</td>
          <td>Day 1 GoLive confirmed; all TBD apps live in JV; 3500+ users on JV domain; Bosch-led JV operational; no TSA; proceed to Hypercare</td>
        </tr>
        <tr>
          <td><strong>QG5</strong></td><td>31 Oct 2027</td>
          <td>Hypercare stable; JV IT fully operational; all TBD apps stable; Project Charlie formally closed</td>
        </tr>
      </table>
    </div>
    <!-- Risks -->
    <div class="section">
      ...
      <div class="risk-card amber">
        <div class="rt">Robert Bosch GmbH/JV Bandwidth â€” P4Ã—I4 = 16 â— AMBER</div>
        <div class="rm">3-month sprint Aprâ€“Jun; split focus. Dedicated lead + SteerCo cadence in place.</div>
      </div>
      <div class="risk-card amber">
        <div class="rt">JV Legal Registration (India MCA) â€” P3Ã—I5 = 15 â— AMBER</div>
        <div class="rm">4â€“8 week MCA processing time. External India counsel engaged immediately.</div>
      </div>
      <div class="risk-card amber">
        <div class="rt">Jun Build â€” Key Robert Bosch GmbH Staff Unavailable â€” P3Ã—I4 = 12 â— AMBER</div>
      ...
      <div class="risk-card" style="border-color:var(--good);background:#f0fff5">
        <div class="rt" style="color:var(--good)">AD JV Forest Separation â€” P2Ã—I5 = 10 â— GREEN</div>
        <div class="rm">AD build starts Jun 1; dress rehearsal Jun 24â€“26; no backout plan needed.</div>
      </div>
      <div class="risk-card" style="border-color:var(--good);background:#f0fff5">
        <div class="rt" style="color:var(--good)">UAT Window Compressed â€” P3Ã—I4 = 12 â— GREEN</div>
  ...
  <div class="section">
    <span class="section-title">Application Migration â€” 17 AI Apps (Single Wave)</span>
    <div class="grid-2">
      <div>
        ...
        <p style="margin-top:10px"><strong>Approach:</strong> Re-point each app from Robert Bosch GmbH domain / M365 / Azure to JV domain / M365 / Azure. No ERP dependencies. No SAP. Licence change-of-control reviewed by 14 May 2026.</p>
        <p style="margin-top:10px"><strong>Day 1 Activation:</strong> All TBD apps go live simultaneously on 1 Jul 2026 following UAT sign-off on 24 Jun 2026.</p>
      </div>
      <div>
        <table>
          ...
          <tr>
            <td>App Reconfig</td>
            <td>TBD apps</td>
            <td>01â€“16 Jun 2026</td>
            <td><span class="pill a">PLANNED</span></td>
          </tr>
          <tr>
            <td>Integration Testing</td>
            <td>TBD apps</td>
            <td>15â€“23 Jun 2026</td>
            <td><span class="pill a">PLANNED</span></td>
          </tr>
          <tr>
            <td>UAT (3500+ users)</td>
            <td>TBD apps</td>
            <td>18â€“24 Jun 2026</td>
            <td><span class="pill a">PLANNED</span></td>
          </tr>
          <tr>
  ...
  <div class="grid-2" style="margin-bottom:14px">
    ...
    <div class="section">
      ...
      <ol style="font-size:12px;margin-left:18px">
        <li style="margin-bottom:8px"><strong>JV Legal Entity Registration (India)</strong> â€” Must be filed in week 1 of Apr; completed by 30 Apr (QG0). <span class="pill a" style="font-size:10px">CRITICAL</span></li>
        <li style="margin-bottom:8px"><strong>Robert Bosch GmbH Resource Commitment (Jun)</strong> â€” Robert Bosch GmbH infra, AD, and dev teams reserved for all of Jun. <span class="pill a" style="font-size:10px">CRITICAL</span></li>
        <li style="margin-bottom:8px"><strong>AD JV Forest Build (Jun 1â€“12)</strong> â€” Foundation for all 3500+ users and TBD apps. No parallel path. <span class="pill a" style="font-size:10px">CRITICAL</span></li>
        <li style="margin-bottom:8px"><strong>UAT Sign-Off (24 Jun)</strong> â€” Enables QG1/2/3 on 26 Jun; enables GoLive on 1 Jul. <span class="pill a" style="font-size:10px">CRITICAL</span></li>
        <li style="margin-bottom:8px"><strong>Day 1 GoLive (1 Jul 2026)</strong> â€” Legal JV effective date; tied to JV shareholder agreement. <span class="pill r" style="font-size:10px">HARD DATE</span></li>
      </ol>
    </div>
  </div>

  <div class="footer">
    <strong>Project Charlie | Executive Dashboard</strong> &nbsp;|&nbsp;
