...
Generates Bravo_Risk_Register.xlsx using BD_Risk-Register_template_en_V1.0_Dec2023.xlsx
...
BRAVO_RISKS = [
    ...
    },
    {
        ...
        "Deadline":    "14-May-26",
        "Status":      "Green",
        "Notes":       "17 apps is manageable. Early review essential.",
    },
    {
        "Category":    "QR - Quality",
    ...
    },
    {
        ...
        "Deadline":    "10-Apr-26",
        "Status":      "Amber",
        "Notes":       "Bosch leadership control mitigates: BGSW can proceed if Tata team is delayed.",
    },
    {
        "Category":    "LR - Legal",
        ...
        "Deadline":    "30-Apr-26",
        "Status":      "Green",
        "Notes":       "Bosch leadership control reduces legal complexity significantly.",
    },
    {
        "Category":    "CR - Change",
        ...
        "Deadline":    "29-May-26",
        "Status":      "Green",
        "Notes":       "Bosch-led JV reduces risk: BGSW data stewardship retained post-GoLive.",
    },
    {
        "Category":    "ScR - Schedule",
        ...
        "Deadline":    "01-Jul-26",
        "Status":      "Green",
        "Notes":       "No TSA risk as JV is Bosch-led; escalation to BGSW via governance channel available.",
    },
    {
...
def populate_risk_register():
    ...
    ws_info = wb["Info"]
    ws_info["C4"] = "Bravo-RR-001"
    ws_info["C5"] = "Bravo_Risk_Register.xlsx"
    ws_info["C6"] = "Project Bravo - BGSW AI Business Carve-Out into 50/50 JV with Tata"
    ws_info["C7"] = "Bravo"
    ws_info["C8"] = "Riyaz Ahmed Syed Ahmed (BD/MIL-PSM4)"
