...
Generates Bravo_Project_Charter.html

Project Bravo: BGSW AI Business Carve-Out into 50/50 JV with Tata
Bosch leadership control | 2 India sites | 70 users | 17 apps | No ERP | No TSA
"""
...
OUT  = HERE / "Bravo" / "Bravo_Project_Charter.html"
...
<head>
  ...
  <title>Project Bravo – Project Charter</title>
  <style>
    :root {{
...
<body>
  <div class="page">
    ...
    <div class="cover">
      ...
      <h1>Project Bravo</h1>
      <p>BGSW AI Business Carve-Out into 50/50 JV with Tata | Bosch Leadership Control | Combination Model</p>
      <div class="cover-meta">
        <div class="meta-item">
          <span class="meta-label">Project Duration</span>
          01 Apr 2026 – 30 Oct 2026 (7 months)
        </div>
        <div class="meta-item">
          <span class="meta-label">Scope</span>
          2 India Sites · 70 Users · 17 Apps · No ERP · No TSA
        </div>
        <div class="meta-item">
          <span class="meta-label">Carve-Out Model</span>
          Combination (Bosch-led JV with Tata)
        </div>
        <div class="meta-item">
          <span class="meta-label">Budget Baseline</span>
          EUR 554K (Labour) + CAPEX TBC – to be approved at QG0
        </div>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <p><strong>Objective:</strong> Execute the carve-out of the Bosch BGSW AI Business into a newly formed 50/50 Joint Venture (JV) with Tata. Bosch retains leadership control of the JV, making this a non-antitrust-relevant transaction. The project separates AI-specific IT infrastructure, 17 applications, and 70 users across 2 India sites from BGSW's core systems by 1 July 2026 (Day 1 GoLive).</p>
      <p><strong>Strategic Context:</strong> Because Bosch maintains leadership control of the JV, the post-GoLive entity operates effectively as a Bosch-governed company (50% Tata shareholding). This simplifies the separation: no Merger Zone is required, no TSA is needed post-GoLive, and IT continuity risks are significantly reduced. Escalation paths remain via BGSW governance channels.</p>
      <p><strong>Sponsor Customer (Buyer):</strong> Tata (50% shareholder; Bosch holds leadership control).</p>
      <p><strong>Sponsor Contractor (Seller):</strong> Robert Bosch India (BGSW) as the carver entity.</p>
      <p><strong>Programme Manager:</strong> Riyaz Ahmed Syed Ahmed (BD/MIL-PSM4)</p>
    </div>
    ...
    <div class="section">
      ...
      <div class="grid-2">
        ...
        <div>
          ...
          <ul>
            ...
            <li>BGSW core applications (non-AI business)</li>
      ...
      <div class="box" style="margin-top:16px;">
        <div class="box-title">Carve-Out Model: Combination (Bosch-led JV)</div>
        <strong>Structure:</strong> 50/50 Bosch–Tata JV with Bosch holding leadership/operational control. Post-GoLive, the JV operates effectively as a Bosch-governed entity. <strong>No TSA Required:</strong> Because Bosch leads the JV, BGSW IT services are accessible via normal governance channels — no formal TSA contract is needed. <strong>Antitrust:</strong> Not applicable; Bosch leadership control means no merger control filing is required.
      </div>
      <div class="highlight">
    ...
    <div class="section">
      ...
      <table>
        ...
        <tr>
          ...
          <td>JV infra built; 17 apps tested; 70 devices configured; UAT signed</td>
          <td><span class="pill green">QG1/2/3</span></td>
          <td>26 Jun 2026</td>
        </tr>
        <tr>
          <td>4 – Cutover &amp; GoLive</td>
          <td>29 Jun – 02 Jul 2026</td>
          <td>Day 1 GoLive (1 Jul); all 17 apps live; 70 users on JV domain</td>
          <td><span class="pill green">QG4</span></td>
          <td>02 Jul 2026</td>
        </tr>
        <tr>
          <td>5 – Hypercare &amp; Closure</td>
          <td>06 Jul – 30 Oct 2026</td>
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li><strong>JV IT Independence:</strong> JV operates under Bosch leadership with its own AD forest, M365 tenant, and network; zero dependency on BGSW production systems.</li>
        ...
        <li><strong>No TSA Needed:</strong> JV self-sufficient from Day 1; BGSW accessible only via standard Bosch governance channels (not contractual TSA).</li>
        ...
        <li><strong>Programme Closed by 30 Oct 2026</strong> with QG5 passed and lessons learned documented.</li>
      </ul>
    </div>
    ...
    <div class="section">
      ...
      <table>
        ...
        <tr>
          <td>BGSW/JV management bandwidth during 3-month sprint (Apr–Jun)</td>
          <td>P4×I4 = 16</td>
        ...
        <tr>
          <td>Jun 2026 build window: key BGSW IT staff unavailable</td>
          <td>P3×I4 = 12</td>
          <td><span class="pill amber">Amber</span></td>
        ...
        <tr>
          ...
          <td>P2×I5 = 10</td>
          <td><span class="pill green">Green</span></td>
          <td>AD build Jun 1; dress rehearsal Jun 24–26; no backout option</td>
        </tr>
        <tr>
          <td>Tata JV IT team not staffed for May architecture workshops</td>
          <td>P3×I3 = 9</td>
          <td><span class="pill amber">Amber</span></td>
          <td>Confirm Tata nominees at SteerCo kickoff Apr 1; Bosch can proceed independently</td>
        </tr>
      </table>
      <h3>Constraints</h3>
      <ul>
        <li><strong>Hard GoLive Date (1 Jul 2026):</strong> Tied to legal JV effective date; no postponement possible.</li>
        <li><strong>Compressed Timeline:</strong> Only 3 months from start to GoLive (Apr–Jun build); resource availability is critical.</li>
        <li><strong>India MCA Regulatory Timeline:</strong> JV entity registration takes 4–8 weeks; must be initiated in first week of project.</li>
    ...
    <div class="section">
      <h2>Assumptions</h2>
      <ul>
        <li>Bosch holds JV leadership/operational control; Tata holds 50% equity only — no antitrust filing is required.</li>
        <li>Tata JV IT team representatives will be nominated and engaged by 10 April 2026.</li>
        <li>BGSW management commits dedicated carve-out lead for the full 7-month duration.</li>
        <li>Budget baseline (EUR 554K labour + TBC CAPEX) is approved at QG0 Steering Committee (30 Apr 2026).</li>
        <li>No competing major IT initiatives in BGSW during Apr–Jul 2026 that would draw resources from carve-out.</li>
        <li>Application and user scope is stable at 17 apps and 70 users; additions post-QG0 require change control.</li>
    ...
    <div class="footer">
      <strong>Project Bravo | Project Charter</strong><br/>
      Issued: 03 April 2026 &nbsp;|&nbsp; Seller: Bosch BGSW &nbsp;|&nbsp; Buyer: Tata &nbsp;|&nbsp;
      PM: Riyaz Ahmed Syed Ahmed (BD/MIL-PSM4) &nbsp;|&nbsp;
      Next Review: QG0 (30 April 2026) &nbsp;|&nbsp; Confidential — Internal Use Only
    </div>
  </div>
</body>
</html>"""
