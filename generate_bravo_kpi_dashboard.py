...
Generates Bravo_Management_KPI_Dashboard.html
...
OUT      = HERE / "Bravo" / "Bravo_Management_KPI_Dashboard.html"
...
<head>
  ...
  <title>Project Bravo – Management KPI Dashboard</title>
  <style>
    :root {{
...
<div class="page">
  ...
  <div class="header">
    <div>
      ...
      <h1>Project Bravo — Management KPI Dashboard</h1>
      <div class="sub">BGSW AI Business → 50/50 JV with Tata &nbsp;|&nbsp; Bosch Leadership Control &nbsp;|&nbsp; Combination Model &nbsp;|&nbsp; No TSA</div>
      <div class="sub" style="margin-top:4px">PM: Riyaz Ahmed Syed Ahmed (BD/MIL-PSM4) &nbsp;|&nbsp; {today.strftime('%d %b %Y')}</div>
    </div>
    <div class="header-right">
      <div class="big">{days_to(golive)}</div>
      <div>days to GoLive</div>
      <div style="margin-top:6px;opacity:.75">01 Jul 2026</div>
    </div>
  </div>
  ...
  <div class="grid-12">
    ...
    <div class="card col-6">
      ...
      <table>
        ...
        <tr><td>QG0 – Initialization</td><td>30 Apr 2026</td><td>{days_to(qg0):+d}</td><td><span class="pill pa">UPCOMING</span></td></tr>
        <tr><td>QG1/2/3 – Combined</td><td>26 Jun 2026</td><td>{days_to(qg123):+d}</td><td><span class="pill pa">PLANNED</span></td></tr>
        <tr><td>GoLive – Day 1</td><td>01 Jul 2026</td><td>{days_to(golive):+d}</td><td><span class="pill pa">PLANNED</span></td></tr>
        <tr><td>QG4 – GoLive Gate</td><td>02 Jul 2026</td><td>{days_to(qg4):+d}</td><td><span class="pill pa">PLANNED</span></td></tr>
        <tr><td>QG5 – Programme Close</td><td>30 Oct 2026</td><td>{days_to(qg5):+d}</td><td><span class="pill pa">PLANNED</span></td></tr>
      </table>
  ...
  <div class="grid-12">
    <div class="card col-8">
      ...
      <table>
        <tr><th>#</th><th>Risk Description</th><th>Cat</th><th>P×I</th><th>Status</th><th>Owner</th></tr>
        <tr>
          <td>1</td>
          <td>BGSW/JV bandwidth constrained during Apr–Jun sprint</td>
          <td>ScR</td><td><strong>16</strong></td>
          <td><span class="pill pa">Amber</span></td>
          <td>Riyaz Ahmed, BGSW CIO</td>
        </tr>
        <tr>
          <td>2</td>
        ...
        <tr>
          ...
          <td><span class="pill pa">Amber</span></td>
          <td>Finance, BGSW Procurement</td>
        </tr>
        <tr>
          <td>5</td>
          <td>Key BGSW IT staff unavailable in Jun build window</td>
          <td>RR</td><td><strong>12</strong></td>
          <td><span class="pill pa">Amber</span></td>
          <td>BGSW HR, Riyaz Ahmed</td>
        </tr>
        <tr>
          <td>10</td>
          ...
          <td><span class="pill pa">Amber</span></td>
          <td>Riyaz Ahmed, Tata Sponsor</td>
        </tr>
      </table>
    </div>
    <div class="card col-4">
      ...
      <table>
        ...
        <tr><td>Structure</td><td>50/50 Bosch–Tata JV</td></tr>
  ...
  <div class="grid-12">
    <div class="card col-6">
      ...
      <div class="gauge-wrap">
        <div class="gauge" style="background:var(--lt)">
          ...
          <div style="font-size:11px;color:var(--good);margin-top:4px">● On target</div>
        </div>
        <div class="gauge" style="background:#fff8e1">
          ...
          <div style="font-size:11px;color:var(--warn);margin-top:4px">● Approval at QG0</div>
        </div>
        <div class="gauge" style="background:#f0fff5">
          ...
          <div style="font-size:11px;color:var(--good);margin-top:4px">● Reserved</div>
        </div>
      </div>
    ...
    <div class="card col-6">
      ...
      <div class="action-row">
        <div class="action-date">Apr 3–7</div>
      ...
      <div class="action-row">
        ...
        <div class="action-body"><strong>Confirm Tata JV IT team nominees</strong> for May architecture workshops</div>
      </div>
      <div class="action-row">
      ...
      <div class="action-row">
        ...
        <div class="action-body"><strong>QG0 Steering Committee</strong> — charter approval; CAPEX budget sign-off</div>
      </div>
      <div class="action-row">
        <div class="action-date">May 1</div>
        <div class="action-body"><strong>Start Phase 2</strong> — app deep-dives, architecture workshops, M365/Azure RFQ</div>
      </div>
      <div class="action-row">
      ...
      <div class="action-row">
        ...
        <div class="action-body"><strong>Enforce June leave freeze</strong> for critical BGSW team; knowledge documented</div>
      </div>
      <div class="action-row">
        <div class="action-date">Jun 1</div>
        <div class="action-body"><strong>Start Phase 3 build</strong> — AD forest, M365 tenant, Azure, network (2 India sites)</div>
      </div>
    </div>
  </div>

  <div class="footer">
    <strong>Project Bravo | Management KPI Dashboard</strong> &nbsp;|&nbsp;
